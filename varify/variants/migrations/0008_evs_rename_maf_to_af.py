...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('evs', 'all_maf', 'all_af')
        db.rename_column('evs', 'ea_maf', 'ea_af')
        db.rename_column('evs', 'aa_maf', 'aa_af')

    def backwards(self, orm):
        db.rename_column('evs', 'all_af', 'all_maf')
        db.rename_column('evs', 'ea_af', 'ea_maf')
        db.rename_column('evs', 'aa_af', 'aa_maf')
