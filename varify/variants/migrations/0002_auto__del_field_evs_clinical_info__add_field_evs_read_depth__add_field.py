...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'EVS.clinical_info'
        db.rename_column('evs', 'clinical_info', 'clinical_association')

        # Adding field 'EVS.read_depth'
        db.add_column('evs', 'read_depth', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Changing field 'EVS.ea_ac_ref'
        db.alter_column('evs', 'ea_ac_ref', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    def backwards(self, orm):
        ...
        # Renaming field 'EVS.clinical_association'
        db.rename_column('evs', 'clinical_association', 'clinical_info')

        # Deleting field 'EVS.read_depth'
        db.delete_column('evs', 'read_depth')

        # Changing field 'EVS.ea_ac_ref'
        db.alter_column('evs', 'ea_ac_ref', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'EVS.aa_ac_alt'
        db.alter_column('evs', 'aa_ac_alt', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'EVS.ea_ac_alt'
        db.alter_column('evs', 'ea_ac_alt', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'EVS.all_ac_ref'
        db.alter_column('evs', 'all_ac_ref', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'EVS.all_ac_alt'
        db.alter_column('evs', 'all_ac_alt', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'EVS.aa_ac_ref'
        db.alter_column('evs', 'aa_ac_ref', self.gf('django.db.models.fields.IntegerField')(null=True))
