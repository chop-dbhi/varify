...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EVS', fields ['variant']
        db.create_unique('evs', ['variant_id'])

        # Adding unique constraint on 'ThousandG', fields ['variant']
        db.create_unique('1000g', ['variant_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ThousandG', fields ['variant']
        db.delete_unique('1000g', ['variant_id'])

        # Removing unique constraint on 'EVS', fields ['variant']
        db.delete_unique('evs', ['variant_id'])
    ...
    models = {
        ...
        'variants.evs': {
            ...
            'aa_af': ('django.db.models.fields.FloatField', [], {'null': 'True', 'db_index': 'True'}),
            ...
            'all_af': ('django.db.models.fields.FloatField', [], {'null': 'True', 'db_index': 'True'}),
            ...
            'ea_af': ('django.db.models.fields.FloatField', [], {'null': 'True', 'db_index': 'True'}),
            ...
            'variant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evs'", 'unique': 'True', 'to': "orm['variants.Variant']"})
        },
        ...
        'variants.thousandg': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'variant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'thousandg'", 'unique': 'True', 'to': "orm['variants.Variant']"})
        },
        'variants.variant': {
        ...
        'variants.varianteffect': {
            ...
            'gene': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['genes.Gene']", 'null': 'True', 'blank': 'True'}),
            'hgvs_c': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'hgvs_p': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'segment': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
