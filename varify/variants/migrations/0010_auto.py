...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'VariantPhenotype', fields ['hgmd_id']
        db.create_index('variant_phenotype', ['hgmd_id'])


    def backwards(self, orm):
        # Removing index on 'VariantPhenotype', fields ['hgmd_id']
        db.delete_index('variant_phenotype', ['hgmd_id'])
