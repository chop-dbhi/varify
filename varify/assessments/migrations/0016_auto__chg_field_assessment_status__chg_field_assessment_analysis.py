...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assessment.status'
        db.alter_column('assessment', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Assessment.analysis'
        db.alter_column('assessment', 'analysis_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analyses.Analysis']))

    def backwards(self, orm):

        # Changing field 'Assessment.status'
        db.alter_column('assessment', 'status', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Assessment.analysis'
        db.alter_column('assessment', 'analysis_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analyses.Analysis'], null=True))
    ...
    models = {
        ...
        'assessments.assessment': {
            ...
            'analysis': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['analyses.Analysis']"}),
