...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        AssessmentCategory = orm['assessments.assessmentcategory']
        if not AssessmentCategory.objects.filter(pk=7).exists():
            AssessmentCategory(pk=7, name='Other').save()

    def backwards(self, orm):
        orm['assessments.assessmentcategory'].objects.filter(pk=7).delete()
