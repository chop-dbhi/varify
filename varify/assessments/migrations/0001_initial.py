...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('assessments', ['Pathogenicity'])
        ...
        db.send_create_signal('assessments', ['Category'])

        # Adding model 'ParentalResult'
        db.create_table('parental_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('assessments', ['ParentalResult'])

        # Adding model 'SangerResult'
        db.create_table('sanger_result', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('assessments', ['SangerResult'])

        # Adding model 'Assessment'
        db.create_table('assessment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('evidence_details', self.gf('django.db.models.fields.TextField')(null=True)),
            ('sanger_requested', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assessments.Category'])),
            ('father_result', self.gf('django.db.models.fields.related.ForeignKey')(related_name='father', to=orm['assessments.ParentalResult'])),
            ('mother_result', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mother', to=orm['assessments.ParentalResult'])),
            ('pathogenicity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assessments.Pathogenicity'])),
            ('sample_result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Result'])),
            ('sanger_result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assessments.SangerResult'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('assessments', ['Assessment'])


    def backwards(self, orm):
        # Deleting model 'Pathogenicity'
        db.delete_table('pathogenicity')

        # Deleting model 'Category'
        db.delete_table('category')

        # Deleting model 'ParentalResult'
        db.delete_table('parental_result')

        # Deleting model 'SangerResult'
        db.delete_table('sanger_result')
    ...
    models = {
        'assessments.assessment': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assessments.Category']"}),
