...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Assessment.category'
        db.delete_column('assessment', 'category_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Assessment.category'
        db.add_column('assessment', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assessments.Category'], null=True, blank=True),
                      keep_default=False)
