...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assessment', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Draft', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assessment.analysis'
        db.add_column('assessment', 'analysis',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['analyses.Analysis'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.status'
        db.delete_column('assessment', 'status')

        # Deleting field 'Assessment.analysis'
        db.delete_column('assessment', 'analysis_id')
