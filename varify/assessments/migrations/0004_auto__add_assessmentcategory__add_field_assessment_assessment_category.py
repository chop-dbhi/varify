...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assessment_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('assessments', ['AssessmentCategory'])

        # Adding field 'Assessment.assessment_category'
        db.add_column('assessment', 'assessment_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assessments.AssessmentCategory'], null=True, blank=True),
                      keep_default=False)
        
    def backwards(self, orm):
        # Deleting model 'AssessmentCategory'
        db.delete_table('assessment_category')

        # Deleting field 'Assessment.assessment_category'
        db.delete_column('assessment', 'assessment_category_id')
