...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.notes'
        db.add_column('assessment', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assessment.created'
        db.add_column('assessment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Assessment.modified'
        db.add_column('assessment', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 4, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.notes'
        db.delete_column('assessment', 'notes')

        # Deleting field 'Assessment.created'
        db.delete_column('assessment', 'created')

        # Deleting field 'Assessment.modified'
        db.delete_column('assessment', 'modified')
