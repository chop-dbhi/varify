...
define(['underscore', 'marionette', 'tpl!templates/varify/tables/header.html'], function() {
  var Header, Marionette, templates, _, _ref;
  _ = arguments[0], Marionette = arguments[1], templates = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
