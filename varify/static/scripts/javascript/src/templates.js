...
define(['underscore', './utils', 'cilantro/utils/numbers'], function(_, utils, Numbers) {
  var assessmentMetrics, assessmentRows, category, cohortVariantDetailList, condensedFlags, dbSNPLink, geneLinks, genomicPosition, genotype, hgmdLinks, hgvsC, hgvsP, pathogenicity, variantEffects, _renderGene, _renderTranscript, _renderVariantEffect;
