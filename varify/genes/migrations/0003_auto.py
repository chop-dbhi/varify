...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GenePhenotype', fields ['hgmd_id']
        db.create_index('gene_phenotype', ['hgmd_id'])


    def backwards(self, orm):
        # Removing index on 'GenePhenotype', fields ['hgmd_id']
        db.delete_index('gene_phenotype', ['hgmd_id'])
