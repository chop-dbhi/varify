...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GeneSet.description'
        db.delete_column('geneset', 'description')

        # Deleting field 'GeneSet.context'
        db.delete_column('geneset', 'context_id')


    def backwards(self, orm):
        # Adding field 'GeneSet.description'
        db.add_column('geneset', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GeneSet.context'
        db.add_column('geneset', 'context',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['avocado.DataContext'], unique=True, null=True, blank=True),
                      keep_default=False)
