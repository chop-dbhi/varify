...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        orm['samples.CohortVariant'].objects.all().delete()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 30, 11, 20, 13, 72562)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 30, 11, 20, 13, 72156)'}),
