...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Sample', fields ['batch', 'name']
        db.delete_unique('sample', ['batch_id', 'name'])

        # Adding unique constraint on 'Sample', fields ['version', 'batch', 'name']
        db.create_unique('sample', ['version', 'batch_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sample', fields ['version', 'batch', 'name']
        db.delete_unique('sample', ['version', 'batch_id', 'name'])
