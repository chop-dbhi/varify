...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cohort.name'
        db.alter_column('project_cohort', 'name', self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=100))

        # Changing field 'Cohort.label'
        db.alter_column('project_cohort', 'label', self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=100))

        # Changing field 'Project.name'
        db.alter_column('project', 'name', self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=100))

        # Changing field 'Project.label'
        db.alter_column('project', 'label', self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=100))

        # Changing field 'Sample.name'
        db.alter_column('sample', 'name', self.gf('django.db.models.fields.CharField')(default='placeholder', max_length=100))

        # Changing field 'Sample.label'
        db.alter_column('sample', 'label', self.gf('django.db.models.fields.CharField')(default='placholder', max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Cohort.name'
        db.alter_column('project_cohort', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Cohort.label'
        db.alter_column('project_cohort', 'label', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Project.name'
        db.alter_column('project', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Project.label'
        db.alter_column('project', 'label', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Sample.name'
        db.alter_column('sample', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Sample.label'
        db.alter_column('sample', 'label', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
