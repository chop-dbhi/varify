...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.alter_column('cohort_variant', 'id', self.gf('varify.core.models.BigAutoField')(primary_key=True))
        ...
        #db.alter_column('sample_result', 'id', self.gf('varify.core.models.BigAutoField')(primary_key=True))
        # Override auto generated migration code
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CohortVariant.id'
        #db.alter_column('cohort_variant', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
        # Override auto generated migration code
        db.execute('ALTER TABLE "cohort_variant" ALTER COLUMN "id" TYPE integer')

        # Changing field 'Result.id'
        #db.alter_column('sample_result', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
        # Override auto generated migration code
        db.execute('ALTER TABLE "sample_result" ALTER COLUMN "id" TYPE integer')
        # Change FK fields 'result_score.result_id' and 'assessment.sample_result_id'
        db.execute('ALTER TABLE "result_score" ALTER COLUMN "result_id" TYPE integer')
        db.execute('ALTER TABLE "assessment" ALTER COLUMN "sample_result_id" TYPE integer')
