...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.raw_read_depth'
        db.add_column('sample_result', 'raw_read_depth',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.raw_read_depth'
        db.delete_column('sample_result', 'raw_read_depth')
