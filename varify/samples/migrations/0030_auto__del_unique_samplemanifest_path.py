...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SampleManifest', fields ['path']
        db.delete_unique('sample_manifest', ['path'])


    def backwards(self, orm):
        # Adding unique constraint on 'SampleManifest', fields ['path']
        db.create_unique('sample_manifest', ['path'])
