...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cohort.batch'
        db.add_column('cohort', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Batch'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cohort.batch'
        db.delete_column('cohort', 'batch_id')
