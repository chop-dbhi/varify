...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        orm['samples.Sample'].objects.update(project=None)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 17, 9, 40, 651120)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 17, 9, 40, 650898)'}),
