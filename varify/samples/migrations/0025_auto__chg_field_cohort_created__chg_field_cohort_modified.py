...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cohort.created'
        db.alter_column('cohort', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Cohort.modified'
        db.alter_column('cohort', 'modified', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Cohort.created'
        db.alter_column('cohort', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Cohort.modified'
        db.alter_column('cohort', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
