...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cohort.description'
        db.delete_column('cohort', 'description')

        # Deleting field 'Cohort.context'
        db.delete_column('cohort', 'context_id')


    def backwards(self, orm):
        # Adding field 'Cohort.description'
        db.add_column('cohort', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cohort.context'
        db.add_column('cohort', 'context',
