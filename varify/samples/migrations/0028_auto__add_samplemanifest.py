...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SampleManifest'
        db.create_table('sample_manifest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('sample', self.gf('django.db.models.fields.related.OneToOneField')(related_name='manifest', unique=True, to=orm['samples.Sample'])),
            ('path', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('samples', ['SampleManifest'])


    def backwards(self, orm):
        # Deleting model 'SampleManifest'
        db.delete_table('sample_manifest')
