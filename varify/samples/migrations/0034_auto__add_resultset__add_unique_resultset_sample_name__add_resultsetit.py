...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('result_set', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(related_name='result_sets', to=orm['samples.Sample'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('samples', ['ResultSet'])

        # Adding unique constraint on 'ResultSet', fields ['sample', 'name']
        db.create_unique('result_set', ['sample_id', 'name'])

        # Adding model 'ResultSetItem'
        db.create_table('result_set_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.Result'])),
            ('set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samples.ResultSet'])),
        ))
        db.send_create_signal('samples', ['ResultSetItem'])

        # Adding unique constraint on 'ResultSetItem', fields ['result', 'set']
        db.create_unique('result_set_item', ['result_id', 'set_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ResultSetItem', fields ['result', 'set']
        db.delete_unique('result_set_item', ['result_id', 'set_id'])

        # Removing unique constraint on 'ResultSet', fields ['sample', 'name']
        db.delete_unique('result_set', ['sample_id', 'name'])

        # Deleting model 'ResultSet'
        db.delete_table('result_set')

        # Deleting model 'ResultSetItem'
        db.delete_table('result_set_item')
