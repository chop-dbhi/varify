...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sample.project'
        db.add_column('sample', 'project', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='samples', to=orm['samples.Project']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sample.project'
        db.delete_column('sample', 'project_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 17, 2, 48, 425801)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 17, 2, 48, 425585)'}),
