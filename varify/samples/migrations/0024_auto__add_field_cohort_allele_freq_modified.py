...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cohort.allele_freq_modified'
        db.add_column('cohort', 'allele_freq_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cohort.allele_freq_modified'
        db.delete_column('cohort', 'allele_freq_modified')
